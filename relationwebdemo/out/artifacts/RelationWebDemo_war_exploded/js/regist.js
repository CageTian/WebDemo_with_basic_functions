...
$(function() {
    ...
    // $("#submitBtn").hover(
    //     function() {
    //         $("#submitBtn").attr("src", "/resource/regist2.jpg");
    //     },
    //     function() {
    //         $("#submitBtn").attr("src", "/resource/regist1.jpg");
    //     }
    // );
...
function validateUsername() {
     ...
     */
    $.ajax({
        url:"/relationwebdemo/RegisteServlet",//要请求的servlet
        data:{method:"ajaxVerifyName", username:value},//给服务器的参数
        type:"POST",
        dataType:"json",
...
function validateEmail() {
    ...
    $.ajax({
        url:"/relationwebdemo/RegisteServlet",//要请求的servlet
        data:{method:"ajaxVerifyEmail", email:value},//给服务器的参数
        type:"POST",
        dataType:"json",
        async:false,//是否异步请求，如果是异步，那么不会等服务器返回，我们这个函数就向下运行了。
        cache:false,
